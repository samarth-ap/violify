      ...
      <Card className="w-full max-w-lg bg-white shadow-2xl rounded-3xl overflow-hidden border-0">
        <div className="px-12 pt-10 pb-12">
          ...
          <div className="text-center mt-10 mb-10">
            ...
            />
            <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Log In to Violify</h2>
          ...
          <form onSubmit={handleEmailLogin}>
            ...
            <div className="flex items-center justify-between mt-5 mb-7">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-[#FF901F] border-gray-300 rounded focus:ring-[#FF901F]"
                />
                <span className="text-sm text-gray-500">Remember me</span>
              </label>
              <button type="button" className="text-sm text-[#FF901F] hover:underline font-medium">
                Forgot password?
              </button>
            </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-[#9ACD32] hover:bg-[#8AB82A] text-white rounded-xl font-semibold text-sm tracking-wide transition-all shadow-sm hover:shadow-md disabled:opacity-50"
            >
