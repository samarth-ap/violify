        ...
        <div className="p-8">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="text-sm text-[#FF901F] hover:underline"
              >
                Forgot Password?
              </button>
            </div>
          ...
          <div className="text-center mb-4">
            ...
            <Button
              onClick={onSignUp}
              variant="outline"
              className="w-full border-2 border-[#FF901F] text-[#FF901F] hover:bg-orange-50 py-3 rounded-lg transition-all font-semibold"
            >
